...
export const OPENAPI_RESPONSE_SCHEMAS: Record<string, SchemaObject> = {
  ...
  PlatformController_getMarketplaceFeeResponse: {
    type: 'object',
    properties: {
      defaultMarketplaceFeeBps: {
        type: 'number',
        nullable: true,
        description: 'Campo default marketplace fee bps expuesto por el runtime actual.',
      },
      source: {
        type: 'string',
        description: 'Campo source expuesto por el runtime actual.',
      },
      maximumMarketplaceFeeBps: {
        type: 'number',
        description: 'Campo maximum marketplace fee bps expuesto por el runtime actual.',
      },
    },
    required: ['defaultMarketplaceFeeBps', 'source', 'maximumMarketplaceFeeBps'],
    additionalProperties: false,
  },
  PlatformController_updateMarketplaceFeeResponse: {
    type: 'object',
    properties: {
      defaultMarketplaceFeeBps: {
        type: 'number',
  ...
  PlatformController_setClubMarketplaceFeeResponse: {
    type: 'object',
    properties: {
      clubId: {
        type: 'string',
      ...
      businessName: {
        type: 'string',
        description: 'Campo business name expuesto por el runtime actual.',
        example: 'Nébula Club',
      },
      effectiveFeeBps: {
        type: 'number',
        nullable: true,
        description: 'Campo effective fee bps expuesto por el runtime actual.',
      },
      feeSource: {
        type: 'string',
        description: 'Campo fee source expuesto por el runtime actual.',
      },
      businessOverrideFeeBps: {
        type: 'number',
        nullable: true,
        description: 'Campo business override fee bps expuesto por el runtime actual.',
      },
      example: {
        type: 'object',
        properties: {
          ...
          excludesMercadoPagoProcessingFee: {
            type: 'boolean',
            description:
              'Campo excludes mercado pago processing fee expuesto por el runtime actual.',
            example: false,
          },
        },
        required: ['grossAmountCents', 'marketplaceFeeCents', 'excludesMercadoPagoProcessingFee'],
        additionalProperties: false,
        nullable: true,
        description: 'Campo example expuesto por el runtime actual.',
      },
    },
    required: [
      'clubId',
  ...
  PlatformController_removeClubMarketplaceFeeResponse: {
    type: 'object',
    properties: {
      clubId: {
        type: 'string',
  ...
  ClubMarketplaceFeeController_getResponse: {
    type: 'object',
    properties: {
      clubId: {
        type: 'string',
  ...
  CommerceController_processRefundResponse: {
    type: 'object',
    properties: {
      message: {
        type: 'string',
  ...
  MercadoPagoConnectionsController_statusResponse: {
    ...
    properties: {
      ...
      accountHint: {
        type: 'string',
        nullable: true,
        description: 'Campo account hint expuesto por el runtime actual.',
      },
      connectedAt: {
        type: 'string',
        format: 'date-time',
        nullable: true,
        description: 'Campo connected at expuesto por el runtime actual.',
        example: '2026-09-19T22:00:00.000Z',
      },
      tokenExpiresAt: {
        type: 'string',
        format: 'date-time',
        nullable: true,
        description: 'Campo token expires at expuesto por el runtime actual.',
        example: '2026-09-19T22:00:00.000Z',
      },
      lastError: {
        type: 'string',
    ...
    required: ['provider', 'status', 'accountHint', 'connectedAt', 'tokenExpiresAt', 'lastError'],
    additionalProperties: false,
  },
  MercadoPagoConnectionsController_connectResponse: {
    type: 'object',
    properties: {
      provider: {
        type: 'string',
      ...
      authorizationUrl: {
        type: 'string',
        description: 'Campo authorization url expuesto por el runtime actual.',
      },
      expiresAt: {
        type: 'string',
        format: 'date-time',
    ...
    required: ['provider', 'authorizationUrl', 'expiresAt'],
    additionalProperties: false,
  },
  MercadoPagoConnectionsController_disconnectResponse: {
    type: 'object',
    properties: {
      provider: {
        type: 'string',
  ...
  MercadoPagoOAuthCallbackController_callbackResponse: {
    type: 'string',
  },
  MercadoPagoPaymentsController_webhookResponse: {
    type: 'object',
    properties: {
      received: {
        type: 'boolean',
  ...
  AdminBusinessAccessController_listResponse: {
    type: 'object',
    properties: {
      items: {
        type: 'array',
        items: {
          ...
          properties: {
            ...
            requestedClub: {
              ...
              additionalProperties: false,
              nullable: true,
              description: 'Campo requested club expuesto por el runtime actual.',
            },
            id: {
              type: 'string',
              format: 'uuid',
            ...
            type: {
              type: 'string',
              enum: ['REGISTER_NEW_BUSINESS', 'ADMINISTER_EXISTING_BUSINESS'],
              description: 'Campo type expuesto por el runtime actual.',
            ...
            socialUrl: {
              type: 'string',
              nullable: true,
              description: 'Campo social url expuesto por el runtime actual.',
            },
            comment: {
              type: 'string',
              nullable: true,
              description: 'Campo comment expuesto por el runtime actual.',
            },
            reviewComment: {
              type: 'string',
              nullable: true,
              description: 'Campo review comment expuesto por el runtime actual.',
            },
            requestedClubId: {
              type: 'string',
              format: 'uuid',
  ...
  AdminBusinessAccessController_getResponse: {
    type: 'object',
    properties: {
      request: {
        type: 'object',
        ...
        additionalProperties: false,
        description: 'Campo request expuesto por el runtime actual.',
      },
    },
    required: ['request'],
    additionalProperties: false,
  },
  AdminBusinessAccessController_startReviewResponse: {
    type: 'object',
    properties: {
      request: {
        type: 'object',
  ...
  AdminBusinessAccessController_approveResponse: {
    type: 'object',
    properties: {
      request: {
        type: 'object',
    ...
    required: ['request', 'clubId', 'message'],
    additionalProperties: false,
  },
  AdminBusinessAccessController_rejectResponse: {
    type: 'object',
    properties: {
      message: {
        type: 'string',
  ...
  BusinessAccessController_createResponse: {
    type: 'object',
    properties: {
      message: {
        type: 'string',
  ...
  BusinessAccessController_mineResponse: {
    type: 'object',
    properties: {
      items: {
        type: 'array',
  ...
  BusinessAccessController_getResponse: {
    type: 'object',
    properties: {
      request: {
        type: 'object',
  ...
  BusinessAccessController_cancelResponse: {
    type: 'object',
    properties: {
      request: {
        type: 'object',
...
export const OPENAPI_ERROR_CODES: Record<string, Record<string, string[]>> = {
  ...
  MercadoPagoOAuthCallbackController_callback: {
    ...
    '409': ['MERCADO_PAGO_ACCOUNT_ALREADY_CONNECTED', 'OAUTH_STATE_ALREADY_USED'],
  },
  ...
  AdminBusinessAccessController_list: {},
